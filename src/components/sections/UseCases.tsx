  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1100px] px-6 py-24 max-[620px]:py-16">
        ...
        <div className="mt-12 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-[#e2e8f0] bg-[#e2e8f0] shadow-[0_1px_3px_rgba(15,23,42,0.06)] max-[620px]:grid-cols-1">
          {items.map((item, i) => (
            <div
              key={item.title}
              className="group flex flex-col bg-white p-8 transition-colors duration-300 hover:bg-[#f8fafc]"
            >
              ...
              <p className="mt-2 max-w-[40ch] text-[15px] leading-[1.65] text-[#475569]">{item.desc}</p>
            </div>
          ))}
        </div>
      </div>
